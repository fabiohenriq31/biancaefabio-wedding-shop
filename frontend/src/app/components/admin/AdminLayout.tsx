import { BedDouble, CalendarDays, Camera, ClipboardList, Gift, HandCoins, LayoutDashboard, MessageSquareText, Package, PiggyBank, Trophy, Users } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/admin/gravata', label: 'Hora da gravata', icon: Trophy },
  { to: '/admin/hospedagens', label: 'Hospedagens', icon: BedDouble },
