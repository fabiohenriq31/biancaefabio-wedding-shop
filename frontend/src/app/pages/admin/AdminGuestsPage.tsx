  ...
  return (
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <label className="block md:col-span-2">
              ...
              <input
                ...
                className="w-full rounded-lg bg-[var(--wedding-beige)] px-4 py-3 outline-none"
                placeholder="Ex: Maria, Joao e Ana"
              />
            </label>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
        ...
        <div className="rounded-lg border border-[var(--wedding-beige)] bg-white p-5">
          <p className="text-sm text-[var(--wedding-text-light)]">Nao confirmados</p>
          <p className="mt-2 text-2xl text-[var(--wedding-text)]">{counters.notConfirmed}</p>
        </div>
        <div className="rounded-lg border border-[var(--wedding-beige)] bg-white p-5">
          <p className="text-sm text-[var(--wedding-text-light)]">Criancas</p>
                ...
                <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-start">
                  ...
                  <div className="flex min-w-fit flex-wrap items-center gap-2">
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (!token) return;
                        if (window.confirm(`Remover ${guest.name} da lista de presenca?`)) {
